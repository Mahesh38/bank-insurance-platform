...
4. Wire ULIP list/performance — **FUNC-027**: adapter wired to documented `POST /insurance/lifesave/v1/fund/list` and `POST /insurance/lifesave/v1/fund/performance` (not guessed `/quote/ulipList`). **Live demo 2026-09-13:** those paths **404 NO_ROUTE**; auth on routed Life APIs is 500 `auth_api_internal_server`. GATE-P4 4.1 not claimed.
