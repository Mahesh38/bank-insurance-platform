...
| QA-002 | Persistence API tests + services gate 50% + validation 400 fix | Re-review | Re-review | Fix landed: `JobApiTest.createJob_missingRequiredField_returns400_withValidationError` |
| QA-003 | Pending | — | — | — |
| QA-006 | Pending | — | — | — |
