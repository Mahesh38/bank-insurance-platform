...
|----|-----|------|-------|-------|
| QA-001 | P0 | Introduce JaCoCo + CI coverage verification | Dev | **Done (wiring)** — `008ec04`; residual **Partial** (services 35% interim → QA-002/003). TL+QA Lead **APPROVED** 2026-07-30. |
