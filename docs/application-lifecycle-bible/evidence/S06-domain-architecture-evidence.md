...
| Working state enumerations in code | [`JobStatus.java`](../../../services/1sb-integration-service/src/main/java/com/bank/insurance/onesb/domain/model/JobStatus.java), [`PaymentStatus.java`](../../../services/1sb-integration-service/src/main/java/com/bank/insurance/onesb/domain/model/PaymentStatus.java), [`BankApplicationStatus.java`](../../../services/1sb-integration-service/src/main/java/com/bank/insurance/onesb/domain/model/BankApplicationStatus.java) | Adapter-level state, not platform aggregates |
