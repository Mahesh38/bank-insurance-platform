...
| S07-G5 | Data architecture approved incl. backup and retention | E2 | [`architecture-review/05`](../../platform/architecture-review/05-data-architecture.md); [`ws3-platform/02`](../../platform/ws3-platform/02-information-model.md); [`ws3-platform/03 §8`](../../platform/ws3-platform/03-solution-architecture-r0.md); **physical pack** [`data-architecture/`](../../platform/data-architecture/README.md) (`DATA-001`, `DB-DEC-0001`); DBA verdict in [`dba-aarti.md`](../../governance/change-requests/CR-010/verdicts/dba-aarti.md) | **OPEN — Aarti's signature outstanding** | — |
