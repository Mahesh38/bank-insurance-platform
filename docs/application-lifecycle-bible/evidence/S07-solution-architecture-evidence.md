...
| S07-G5 | Data architecture approved incl. backup and retention | E2 | [`architecture-review/05`](../../platform/architecture-review/05-data-architecture.md); [`ws3-platform/02`](../../platform/ws3-platform/02-information-model.md); [`ws3-platform/03 §8`](../../platform/ws3-platform/03-solution-architecture-r0.md); **physical pack** [`data-architecture/`](../../platform/data-architecture/README.md) (`DATA-001`, `DB-DEC-0001`); **CR-013 delta** [`DATA-002-cr013-alignment.md`](../../platform/data-architecture/DATA-002-cr013-alignment.md) (`DB-DEC-0002` `CHANGES_REQUIRED`); DBA verdict in [`dba-aarti.md`](../../governance/change-requests/CR-010/verdicts/dba-aarti.md) | **OPEN — Aarti's signature outstanding; pack not yet aligned to CR-013** | — |
...
| S07-VT-06 | Data ownership holds in the physical design | **PARTIAL** — physical pack drafted ([`data-architecture/`](../../platform/data-architecture/README.md): schema per context, no cross-schema FK/GRANT). Only two services exist; cross-service access cannot be verified until the IaC scan runs at S09 |
