...
| [`../platform/ws3-platform/09-nip-bff-customer-search-contract.md`](../platform/ws3-platform/09-nip-bff-customer-search-contract.md) | *How does SCR-03 search work for every seat — lead-first, then CBS via Apigee?* | Unified Product/BA/Arch/Eng/Sec/QA/SRE contract (`ARCH-025`). AI-drafted; human Board 1 outstanding |
| [`../platform/ws3-platform/10-nip-bff-screen-descriptor.md`](../platform/ws3-platform/10-nip-bff-screen-descriptor.md) | *How does NIP-APP render form / list / card / carousel from one BFF document, including X→Y→Z fields?* | Screen descriptor + OpenAPI (`ARCH-026` / `ADR-021`). AI-drafted; human Board 1 outstanding |
| [`../platform/ws3-platform/11-nip-bff-screen-runtime.md`](../platform/ws3-platform/11-nip-bff-screen-runtime.md) | *Where is the form stored, who validates submit, which action runs, and where do the values live afterwards?* | Screen runtime (`ARCH-026` / `ADR-021` amendment). Configuration #19 + closed commands. AI-drafted; human Board 1 / Aarti outstanding |
