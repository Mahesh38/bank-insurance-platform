...
| [2026-09-14-au-bank-enterprise-cloud-estate-notes.md](./2026-09-14-au-bank-enterprise-cloud-estate-notes.md) | `VIN-003` — AU bank Control Tower, EDGE FortiGate, TGW, Sify/Airtel DX, cloud onboarding SOP, S3 hosting controls. **Reference only.** Reconciled in [`18-au-bank-enterprise-cloud-estate.md`](../../context/roles/mahesh-principal-insurance-platform-architect/18-au-bank-enterprise-cloud-estate.md) |
