...
```text
Working Decisions → BG-xxx → Capability / Epic → PRD → BRD chapter → BR-xxx → AC → Test / KPI
```
...
| Priority | Meaning |
|----------|---------|
| **P0** | Required for MVP / R0 pilot go-live |
| **P1** | Required soon after pilot / R1 |
| **P2** | Roadmap; not MVP |
| **WORKING** | Locked in Working Decisions Draft v1 — pending formal sponsor validation |
