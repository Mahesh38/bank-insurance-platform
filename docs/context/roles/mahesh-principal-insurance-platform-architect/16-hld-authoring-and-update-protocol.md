...
| Persona files [`09`](./09-target-state-architecture-doctrine.md)–[`15`](./15-actor-identity-and-authorization.md), [`17`](./17-provider-aggregation-and-connectivity.md), [`18`](./18-au-bank-enterprise-cloud-estate.md) | **Grounding** | Horizons, invariants, capability model, segregation, orchestration, provider-aggregation doctrine, **existing AU bank cloud estate** (`BE-01` attach, do not clone) |
...
| [`docs/architecture/2026-09-14-HUMAN-DIRECTION-APIGEE-EGRESS-IDP.md`](../../../architecture/2026-09-14-HUMAN-DIRECTION-APIGEE-EGRESS-IDP.md) | **Grounding · human direction** | Apigee outbound / API Gateway inbound, Dev-inside-UAT, no CUG, AD-verify API. Not an ADR |
