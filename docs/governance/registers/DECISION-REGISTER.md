...
| CR-014 | 2026-09-03 | SCOPE | Stakeholder pull: WS-1 Life LOB adapter (Term+Savings+ULIP), bank-model extraction, typed 1SB JSON, packaging standards, poll/retry + circuit breaker — `EPIC-002` | **CANDIDATE** — transcribed into WS-1 scope artefacts | Human T4 Architecture / Security / Compliance / Operations outstanding. WS-3 R0 catalogue/journey for Savings/ULIP **not** admitted here — see CR-015. [`CR-014`](../change-requests/CR-014-ws1-life-lob-adapter-standards.md) |
| CR-015 | 2026-09-11 | SCOPE | Stakeholder unpark: WS-3 R0 assisted Savings/ULIP journey sales (the bag CR-014 excluded) — proposed `EPIC-004` | **CANDIDATE** — **not transcribed** (HALT CS-1). Parked rows annotated, not deleted | Rajal (R1) + Mahesh (R2) approval outstanding. Kalpana / R12 must refresh `CURRENT-STATE.yaml` before any ADMIT. [`CR-015`](../change-requests/CR-015-ws3-r0-savings-ulip-journey.md) · origin `SUG-20260911-uls` |
