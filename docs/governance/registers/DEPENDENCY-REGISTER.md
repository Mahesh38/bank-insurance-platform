...
| DEP-20260829-cr14 | GLM-001 M3 (bootstrap IaC) | `blocked_by` | CR-014 three human T4 signatures | DECISION | OPEN | Owner Mahesh / Deepali / Shailja. Required-by 2026-09-05 (`DL1`). AI positions are attached as inputs and do not satisfy this |
...
| DEP-20260829-gov | GLM-001 M4.3 (create `governance/platform-governance`) | `blocked_by` | Bank Appendix C exception accepted in writing (`C-ARC-2`, `ASM-021`) | EXTERNAL | OPEN | Owner: bank GitLab platform / architecture authority. Outside this repository's jurisdiction. Fallback in `DEC-20260829-01` §3.2 |
...
| DEP-20260829-cr15 | CR-015 verdict | `blocked_by` | Joint Mahesh + Aarti review (Q1–Q8) | ARCHITECTURAL | OPEN | Aarti not yet convened; Q4 (integrity and recovery guarantees) is hers alone and not substitutable. **Blocks nothing in CR-014** — `C-ARC-3` migrates the service as-is |
