...
| DEP-20260829-m1 | All GLM-001 technical phases | `external` | Eleven bank enterprise inputs (`ASM-014`…`ASM-024`) | EXTERNAL | OPEN | Owner Shivanshi / SRE → bank GitLab platform team. Follow-up 2026-09-19. Kalpana has recorded the programme `DECISION-BLOCKED` on this and will not average it into green |
