...
| → [SUG-20260825-lt1](./SUGGESTION-REGISTER.md#sug-20260825-lt1--lead-lifecycle-archive-vs-paymentpolicy-retention) | After convert + payment, close/archive the working Lead; keep 7-year SoT on Payment, Policy and issuance history | WS-3 | S08 | W1 Opportunity design | GATE-S08 passed and Wave 1 Opportunity / Lead aggregate design starts | MUST | P4 / P2 | Retention split is a Shailja decision; the information model today marks Lead `RET-7Y`. Changing it before W1 is cheap; after first persist it is a migration. S08 does not build that service |
| → [SUG-20260825-of1](./SUGGESTION-REGISTER.md#sug-20260825-of1--off-platform-sale-ingest) | MIS ingest of offline / insurer-portal sales so the book and product-onboarding gap are visible | WS-3 | S08 | R1 | R0 completes a real pilot sale, or R1 planning starts | SHOULD | P5 / P2 | Second origination path is forbidden in R0 (`ADR-005`). Reporting/MIS beyond the pilot funnel is `out_of_scope_now`. This is Policy ingest + Reporting, never `opportunity.create` |
| → [SUG-20260825-st1](./SUGGESTION-REGISTER.md#sug-20260825-st1--stp-non-stp-insta-issuance-modes) | Name STP / non-STP / Insta as issuance modes on Proposal/Policy | WS-3 | S08 | W3 Proposal & Issuance | Wave 3 Proposal / UW / Payment / Policy design starts, and Rajal names the R0 Term value | MUST | P4 / P2 | R0 is one Term path. The dimension is cheap to name before W3 and a migration after. Product has not named the R0 value. Not a Lead state |
| → [SUG-20260825-pp1](./SUGGESTION-REGISTER.md#sug-20260825-pp1--pphi-control-mapping) | Board 6 maps IRDAI PPHI 2024 controls onto the R0 journey — Architecture drafts evidence, does not sign permissibility | WS-3 | S08 | W2 Consent / first regulated action | Shailja opens the PPHI control mapping, or Wave 2 Consent design starts | MUST | P4 / P1 | Standing constraints already encode several PPHI-adjacent hard gates. Interpretation and residual gaps are Shailja's. No agent may declare PPHI-compliant |
