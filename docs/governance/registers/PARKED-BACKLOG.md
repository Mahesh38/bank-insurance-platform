...
|----|------|----|-----------|--------------|----------------|------------------|----------------|----------------|
| → [SUG-20260913-ihb](./SUGGESTION-REGISTER.md#sug-20260913-ihb--build-integration-hub-service-for-bff) | Implement `integration-hub-service` (#14) beyond skeleton: bank-language ACL, route BFF/platform calls to provider adapters (1SB now; ICICI/HDFC later). Not masters-only (`SUG-20260913-hms`); not direct BFF→1SB. | WS-1 | L7 / S08 | S11 / first named Hub API for BFF | NIP BFF or RM assisted Life screens need provider ops through Hub (S11 / EPIC-004 FUNC), or Architecture opens a named Hub API epic for BFF | MUST | P4 / P1 | SF3: S08/Phase 4 do not need Hub runtime; skeleton exists; hop already recorded (`SUG-20260913-acl`). X1/X5/X7 fail now. ICICI/HDFC stay Phase B / E13 |
