# SWS-direct-insurer-adapter-service — Direct Insurer Adapter

| | |
|---|---|
| **SWS ID** | `SWS-direct-insurer-adapter-service` |
| **Module** | `direct-insurer-adapter-service` |
| **Service id** | `direct-insurer` |
| **Port** | `8105` |
