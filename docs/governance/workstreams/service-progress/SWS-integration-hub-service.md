# SWS-integration-hub-service — Integration Hub

| | |
|---|---|
| **SWS ID** | `SWS-integration-hub-service` |
| **Module** | `integration-hub-service` |
| **Service id** | `integration-hub` |
| **Port** | `8100` |
...
- SWS-1sb-integration-service
- SWS-direct-insurer-adapter-service
- domain services via Hub only
