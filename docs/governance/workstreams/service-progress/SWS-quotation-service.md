# SWS-quotation-service — Quotation

| | |
|---|---|
| **SWS ID** | `SWS-quotation-service` |
| **Module** | `quotation-service` |
| **Service id** | `quotation` |
| **Port** | `8096` |
| **Cluster** | WS-3 |
...
- SWS-suitability-service
- SWS-product-catalogue-service
