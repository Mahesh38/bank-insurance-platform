# SWS-workforce-access-bff — Workforce Access BFF

| | |
|---|---|
| **SWS ID** | `SWS-workforce-access-bff` |
...
Implemented edge BFF under WS-2; Flutter never receives OAuth tokens.
...
- SWS-identity-provider-adapter-service
