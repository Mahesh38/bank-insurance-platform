 ...
 * different responses. The ArchUnit rule stops a service reaching for {@code
 * ServiceErrorResponse.builder()}; leaving these would have left the same door open one method
 * along.
 */
@Getter
public class ServiceException extends RuntimeException {
  ...
  public static final class Builder {
    ...
    public Builder service(String v) {
      diagnostic.service(v);
      return this;
    }

    public Builder layer(PlatformLayer v) {
      diagnostic.layer(v);
      return this;
    }

    public Builder component(String v) {
      diagnostic.component(v);
      return this;
    }

    public Builder operation(String v) {
      diagnostic.operation(v);
      return this;
    }

    public Builder remediation(String v) {
      diagnostic.remediation(v);
      return this;
    }

    public Builder origin(ErrorOrigin v) {
      diagnostic.origin(v);
      return this;
    }
    ...
    public Builder errors(List<ServiceError> v) {
      this.errors = v;
      return this;
    }
    ...
    /**
     * Emits a status other than the catalogue's, to preserve a behaviour a human already ratified.
     *
     * <p><strong>This is not a convenience.</strong> It exists for one situation: two ratified
     * documents disagree about a code, and neither may be silently overruled by a library. The live
     * example is {@code QUOTE_EXPIRED} — catalogue 04 §6, {@code VR-082} and {@code INV-QUO-04} say
     * 409 for an offer selected past its validity window, while {@code FUNC-004} AC-2 (TL + QA
     * approved) says 410 for a proposal schema requested against a quote job that is gone. Two
     * conditions wearing one code; deciding which keeps the name is the catalogue owner's call, not
     * this library's.
     *
     * <p>{@code ratifiedBy} is mandatory, so {@code grep -rn statusOverride} enumerates every
     * outstanding discrepancy. Every use belongs in {@code 07-PLATFORM-ERROR-CONTRACT.md §13}.
     *
    ...
    public ServiceException build() {
      ...
      return cause != null ? new ServiceException(response, cause) : new ServiceException(response);
    }
