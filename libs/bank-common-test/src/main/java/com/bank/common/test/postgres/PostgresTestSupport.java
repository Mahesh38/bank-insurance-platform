 ...
 * datasource properties via {@link #register(PostgreSQLContainer, org.springframework.test.context.DynamicPropertyRegistry)}.
 */
public final class PostgresTestSupport {
    ...
    /**
     * Binds Spring datasource properties to a started container. Driver is forced to PostgreSQL
     * so profiles that default to H2 cannot silently win.
     */
