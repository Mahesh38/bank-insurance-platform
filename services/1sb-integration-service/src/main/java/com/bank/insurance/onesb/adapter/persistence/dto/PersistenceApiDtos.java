...
public final class PersistenceApiDtos {
    ...
    /**
     * Mirrors {@code com.bank.persistence.api.internal.v1.dto.CreateAuditEventRequest}.
     * {@code metadata} is a JSON string, already PII-masked by the adapter (RISK-012).
     */
