package com.bank.platform.customer.architecture;
...
/**
 * Hexagonal skeleton fitness tests for bounded context #4 — Customer.
 *
...
class ServiceArchitectureTest {
    ...
    private static final String BASE_PACKAGE = "com.bank.platform.customer";
