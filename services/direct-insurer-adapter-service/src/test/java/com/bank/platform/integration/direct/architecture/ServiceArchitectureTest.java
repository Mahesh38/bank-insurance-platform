package com.bank.platform.integration.direct.architecture;
...
/**
 * Hexagonal skeleton fitness tests for bounded context #adapter-direct — Direct Insurer Adapter.
 *
...
class ServiceArchitectureTest {
    ...
    private static final String BASE_PACKAGE = "com.bank.platform.integration.direct";
