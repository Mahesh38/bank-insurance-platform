package com.bank.platform.integration.hub.architecture;
...
/**
 * Hexagonal skeleton fitness tests for bounded context #14 — Integration Hub.
 *
...
class ServiceArchitectureTest {
    ...
    private static final String BASE_PACKAGE = "com.bank.platform.integration.hub";
