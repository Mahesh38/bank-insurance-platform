package com.bank.platform.payment.architecture;
...
/**
 * Hexagonal skeleton fitness tests for bounded context #12 — Payment.
 *
...
class ServiceArchitectureTest {
    ...
    private static final String BASE_PACKAGE = "com.bank.platform.payment";
